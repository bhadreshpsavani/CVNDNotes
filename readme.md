...
Canny Edge Detector: widely used, accuarate edge detection algorithm
...
Hough Transformation: Hough on the edge-detected image is used after canny edge detection to make continues line 
